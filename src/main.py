...
parser.add_argument('-a', '--arch', default='resnet50',
                    help='model architecture (only resnet50 supported)')
parser.add_argument('-j', '--workers', default=8, type=int, metavar='N',
                    help='number of data loading workers (default: 8)') # sul mio PC ne consiglia 8!!
...
def main():
    ...
    ngpus_per_node = torch.cuda.device_count() or 1 # forza almeno 1 processo quando non cՏ CUDA
...
def train(train_loader, model, optimizer, epoch, args):
    ...
    # tolto top1 e top5 da progress
    progress   = ProgressMeter(
        len(train_loader),
        [batch_time, data_time, losses_meter], 
