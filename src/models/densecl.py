...
from src.components.contrastive_head import ContrastiveHead
from src.components.resnet import resnet50
from src.components.necks  import DenseCLNeck
...
class DenseCL(nn.Module):
    def __init__(self,
        ...
        self.head = ContrastiveHead(temperature=0.1)
    ...
    def forward_train(self, im_q, im_k, **kwargs):
        ...
        loss_contra_single = loss_single * (1 - self.loss_lambda)
        loss_contra_dense  = loss_dense * self.loss_lambda
