...
for MODEL in "${MODELS[@]}"; do
  ...
  RUN_TAG_PATTERN="gpu-4_dataset-${DATA_VERSION_SHORT}_epochs-${EPOCHS}_${MODEL}"

  JOB_NAME="${RUN_TAG_PATTERN}_only_test"        # job-name = RUN_TAG
  OUT_PATH="logs/${RUN_TAG_PATTERN}_only_test.out"
  ERR_PATH="logs/${RUN_TAG_PATTERN}_only_test.err"
